...
ALTER TABLE public.game_questions DROP CONSTRAINT game_questions_game_id_fkey;
...
ALTER TABLE public.player_answers DROP CONSTRAINT player_answers_game_id_fkey;
