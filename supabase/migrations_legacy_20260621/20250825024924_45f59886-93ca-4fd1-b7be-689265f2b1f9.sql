-- Phase 3: Final Cleanup and Code Migration Support
...
-- Step 7: Create index usage statistics function
...
AS $function$
  ...
  WHERE schemaname = 'public' 
    AND tablename IN ('skill_uses', 'skill_effects_queue', 'standardized_skill_targets', 'skill_conflicts')
