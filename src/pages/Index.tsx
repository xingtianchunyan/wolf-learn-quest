...
const Index = () => { const {
  ...
  <FeatureCard title={ t('community_integration') } description={ t('community_desc') } icon={ Users } />;

  <FeatureCard title={ t('ai_knowledge') } description={ t('ai_knowledge_desc') } icon={ Brain } />;

  <FeatureCard title={ t('ai_participants') } description={ t('ai_participants_desc') } icon={ Bot } />;
  </div>
  </div>
  </main>
  <Footer />
