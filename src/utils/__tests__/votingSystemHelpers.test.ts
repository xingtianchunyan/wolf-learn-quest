...
import { calculateVotingSummary  } from
  ...
  canBeVoted,
  calculateVoteWeight,
  formatVoteTime  } from '../votingSystemHelpers';
...
it('应该正确计算基本投票摘要', () =>  {
      ...
      const votes = [
        ...
        { target_id: undefined, is_valid: true 
}, // 弃权票
        { target_id: 'player3', is_valid: false 
}, // 无效票
      ];
 ...
 * 测试状态效果禁止投票
 */
it('应该拒绝被状态效果禁止投票的玩家', () => { const statusEffects =  { can_vote: false  
};
 ...
 * 测试状态效果禁止被投票
 */
it('应该拒绝被状态效果保护的玩家被投票', () => { const statusEffects =  { can_be_voted: false  
};
 ...
 * 测试角色效果权重
 */
it('应该使用角色效果权重', () => { const roleEffects =  { vote_weight: 2  
};
 ...
 * 测试状态效果权重
 */
it('应该使用状态效果权重', () => { const statusEffects =  { vote_weight: 3  
};
 ...
 * 测试角色效果优先级
 */
it('应该优先使用角色效果权重', () => { const roleEffects =  { vote_weight: 2  
};
