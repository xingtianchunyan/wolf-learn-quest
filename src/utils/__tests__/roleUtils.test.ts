...
describe('roleUtils', () => {
  ...
  describe('hasWolfFaction', () => {
    it('should identify wolf faction correctly from RoleDesign', () => {
      expect(hasWolfFaction({ faction: true 
} as any)).toBe(true);
      expect(hasWolfFaction({ faction: false 
} as any)).toBe(false)
});
  ...
  expect(canSeeTargetRole(undefined, 'werewolf')).toBe(false);
    ...
    it('should prioritize RoleDesign faction over role name', () => { const wolfRoleDesign = { faction: true  
};
  ...
  expect(canAccessWerewolfChannel('villager')).toBe(false);
    ...
    it('should prioritize RoleDesign over role name', () => { const wolfRoleDesign = { faction: true  
};
      const villagerRoleDesign = { faction: false  
};
