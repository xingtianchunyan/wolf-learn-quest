...
import { validateSkillUseLimits  } from
  validateSkillPhase,
  validateSkillTarget,
  ...
  getSkillUsageHint,
  validateSkillUsage,
  type SkillQueueItem  } from '../skillSystemValidation';
import { RoleDesign  } from
  RoleState,
  RoleStatus,
  GameState  } from '@/types/skillSystem.types';
 ...
 * 测试有限次数技能的验证 - 新版格式
 */
it('应该正确验证有限次数技能的使用 - 新版格式', () =>  { // 准备测试数据
      const skillConfig: SkillConfig = {
        id: 'seer',
        englishName: 'seer',
        chineseName: '预言家',
 ...
 * 测试角色状态边界情况
 */
it('应该正确处理各种角色状态', () => { const gameState: GameState =  {
        id: 'test-game-id',
        room_id: 'test-room-id',
        status: 'active',
        current_phase: 3,
 ...
 * 测试技能使用限制的边界情况
 */
it('应该正确处理技能使用限制的边界情况', () => { const skillConfig: SkillConfig =  {
        id: 'test-skill',
        englishName: 'test_skill',
        chineseName: '测试技能',
        description: '测试技能描述',
 ...
 * 测试异常数据格式处理
 */
it('应该正确处理异常数据格式', () => { const roleDesign: RoleDesign =  {
        id: 'test-role-id',
        role_name: 'test_role',
        chinese_name: '测试角色',
        skill_name: '', // 空技能名称
...
it('应该正确处理无效的角色状态', () =>  {
  ...
  describe('getSkillUsageSuggestion', () => { const mockRoleState = {
      user_id: 'user-1',
  ...
  describe('validateSkillUsage', () => { const mockRoleDesign = {
      role_name: 'werewolf',
      skill_name: 'night_attack',
    ...
    const mockRoleState = { user_id: 'user-1',
      game_state_id: 'game-1',
      role_status: 'alive' as const,
      round_skill_uses: [],
      created_at: new Date().toISOString(),
    ...
    const mockGameContext = { gameStateId: 'game-1',
      currentRound: 1  
};
  ...
  const result = validateSkillUsage(
    ...
    it('应该允许使用不需要目标的技能', () => { const sleepSkillDesign = {
        ...mockRoleDesign,
        skill_name: 'sleep',
  ...
  describe('getSkillUsageHint', () => { const mockRoleState = {
      user_id: 'user-1',
      game_state_id: 'game-1',
      role_status: 'alive' as const,
      round_skill_uses: [],
    ...
    it('应该为没有技能的角色返回提示', () => { const roleDesign = {
        role_name: 'villager',
        skill_name: '',
        skill_description: '',
    ...
    it('应该为睡觉技能提供正确提示', () => { const roleDesign = {
        role_name: 'villager',
        skill_name: 'Sleep',
    ...
    it('应该为夜晚攻击技能提供正确提示', () => { const roleDesign = {
        role_name: 'werewolf',
        skill_name: 'night_attack',
    ...
    it('应该为预言技能提供正确提示', () => { const roleDesign = {
        role_name: 'seer',
        skill_name: 'prophecy',
    ...
    it('应该为守护技能提供正确提示', () => { const roleDesign = {
        role_name: 'guardian',
        skill_name: 'vigil',
    ...
    it('应该为女巫魔药技能提供正确提示', () => { const roleDesign = {
        role_name: 'witch',
        skill_name: 'magic_potion',
    ...
    it('应该为猎人濒死技能提供正确提示', () => { const roleDesign = {
        role_name: 'hunter',
        skill_name: 'dying_shot',
      ...
      // 濒死状态
      const dyingRoleState = { ...mockRoleState,
    ...
    it('应该为未知技能提供默认提示', () => { const roleDesign = {
        role_name: 'unknown',
        skill_name: 'unknown_skill',
...
it('应该在没有死亡信息时禁止使用解药', () =>  {
      ...
      const gameContext = { gameStateId: 'test-game-id',
        currentRound: 1,
        nightDeaths: []  
};
...
it('应该正确处理旧版女巫魔药格式', () =>  {
    ...
    it('应该在同一轮次夜晚阶段重复使用睡觉技能时禁止使用', () => { const skillConfig: SkillConfig = {
        id: 'villager_sleep',
        englishName: 'Sleep',
        chineseName: '睡觉',
        description: '村民睡觉技能',
    ...
    it('应该正确处理旧版技能使用状态格式', () => {
      ...
      const gameContext = { gameStateId: 'game-1',
        currentRound: 1  
};
    ...
    it('应该正确处理未知的技能使用限制类型', () => { // 这个测试用例验证当技能配置不存在时的默认行为
      const roleState = {
        user_id: 'user-1',
        game_state_id: 'game-1',
        role_status: 'alive' as const,
