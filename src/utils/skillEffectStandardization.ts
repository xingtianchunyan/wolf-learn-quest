 ...
 */
export function standardizeEffectData(effectApplied: any): StandardizedEffectData | null {
 ...
 * 兼容新旧字段名
 */
export function matchesEffectType(effectApplied: any, targetEffectType: string): boolean {
 ...
 * 这是一个一次性数据迁移的辅助函数
 */
export function migrateEffectAppliedData(oldEffectApplied: any): StandardizedEffectData | null {
