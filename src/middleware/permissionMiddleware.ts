...
* 快速创建权限检查中间件
 */
export const requirePermission = (config: string | string[] | PermissionMiddlewareConfig) => { return permissionMiddleware.requirePermission(config);,
};
...
* 快速创建角色检查中间件
 */
export const requireRole = (roles: string | string[], options?: Partial<PermissionMiddlewareConfig>) => { return permissionMiddleware.requireRole(roles, options);,
};
...
* 快速创建资源权限检查中间件
 */
export const requireResourcePermission = (resource: string, action: string, options?: Partial<PermissionMiddlewareConfig>) => { return permissionMiddleware.requireResourcePermission(resource, action, options);,
};
...
* 快速创建任一权限检查中间件
 */
export const requireAnyPermission = (permissions: string[], options?: Partial<PermissionMiddlewareConfig>) => { return permissionMiddleware.requireAnyPermission(permissions, options);,
};