...
export const PERFORMANCE_BUDGET = {
  ...
  // 用户体验指标
  ux: {
    timeToInteractive: 3000, // 可交互时间
    firstContentfulPaint: 1500, // 首次内容绘制
    largestContentfulPaint: 2500, // 最大内容绘制
  },
} as const;
...
export const PERFORMANCE_ALERTS = {
  ...
  // 是否启用自动修复
  autoFix: {
    clearCache: true, // 自动清理缓存
    forceGarbageCollection: false, // 强制垃圾回收（生产环境禁用）
    unsubscribeInactive: true, // 取消订阅不活跃的连接
  },
} as const;
