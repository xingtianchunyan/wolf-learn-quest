export const zh = {
  ...
  admin_access_required_desc: '此页面仅限管理员访问。',
  admin_access_hint:
    '如需授予管理员权限，请在 Supabase Dashboard 中将您账号的 User Metadata 设置为 role: admin。',
  ...
  reset_password: '重置密码',
  new_password: '新密码',
  reset_password_for: '为以下用户设置新密码：',
  update_password: '更新密码',
  confirm_email_status_change: '确认邮箱状态变更',
  confirm_email_status_change_desc: '确认要将此用户标记为',
  mark_as_confirmed: '已确认',
  mark_as_unconfirmed: '未确认',
  cancel: '取消',
  confirm: '确认',
  failed_to_load_users: '加载用户失败',
  password_updated: '密码已更新',
  password_updated_desc: '密码更新成功。',
  failed_to_update_password: '更新密码失败',
  email_confirmation_updated: '邮箱确认状态已更新',
  email_confirmation_updated_desc: '邮箱确认状态更新成功。',
  failed_to_update_confirmation_status: '更新确认状态失败',

  // Error Boundary
  page_error: '页面出现错误',
  app_component_error: '应用程序',
  component_error_suffix: '组件',
  encountered_unexpected_error: '遇到了一个意外错误',
  error_details: '错误详情',
  view_stack_trace: '查看堆栈跟踪',
  retry: '重试',
  recovering: '恢复中...',
  reset_app: '重置应用',
  hide_error_details: '隐藏错误详情',
  show_error_details: '显示错误详情',
  retry_attempts_notice: '已尝试多次重试。如果问题持续存在，请联系技术支持。',

  // Chat
  chat: '聊天',
  loading_chat_history: '加载聊天记录...',
  no_channel_messages: '该频道暂无消息',
  send_channel_message: '发送消息...',
  send: '发送',
  characters: '字符',
  channel_public: '公共',
  channel_team: '小队',
  channel_judge_private: '法官私聊',
  channel_system: '系统',
  channel_all: '全部',

  // Not Found
  not_found_title: '404',
  not_found_desc: '哎呀！页面未找到',
  return_to_home: '返回首页',
};
