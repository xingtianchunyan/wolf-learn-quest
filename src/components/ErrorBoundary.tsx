...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
   ...
   * @param errorInfo - 错误信息
   */
  private async handleErrorWithUnifiedSystem(error: Error, errorInfo: ErrorInfo): Promise<void> {
    try {
      ...
      logger.error('统一错误处理系统处理失败', { handlingError });
