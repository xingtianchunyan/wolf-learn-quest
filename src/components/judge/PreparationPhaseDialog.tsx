...
const PreparationPhaseDialog: React.FC<PreparationPhaseDialogProps> = ({
  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="h-[55vh] bg-werewolf-card border-werewolf-purple/30">
        ...
        <div className="grid grid-cols-12 gap-6 h-full overflow-hidden">
          ...
          <div className="col-span-8 flex flex-col">
                ...
                <ScrollArea className="h-full">
                  <div className="border border-werewolf-purple/30 rounded-md">
                    <Table>
                      ...
                      <TableBody>
                        {players.map(player => <TableRow key={player.id} className="border-werewolf-purple/30">
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-2">
                                {player.isOnline ? <Wifi className="h-4 w-4 text-green-400" /> : <WifiOff className="h-4 w-4 text-red-400" />}
            ...
            <div className="mt-4 flex justify-center">
              <Button onClick={handleStartGame} disabled={!allPlayersReady} className={`px-8 py-3 text-lg ${allPlayersReady ? 'bg-werewolf-purple hover:bg-werewolf-light' : 'bg-gray-600 cursor-not-allowed'}`}>
