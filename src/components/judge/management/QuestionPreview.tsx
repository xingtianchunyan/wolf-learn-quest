          ...
          <>
            <div className='flex-1 mb-4'>
              <Card
                ...
                onClick={() =>
                  currentQuestion && onToggleSelection(currentQuestion)
                }
              >
                <CardHeader className='pb-3'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-2'>
                      ...
                      {currentQuestion && (
                        <Badge
                          className={`text-white ${getDifficultyColor(currentQuestion.difficulty || 1)}`}
                        >
                    ...
                    <>
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className='space-y-1 text-sm'>
                          ...
                          <p
                            className={`text-gray-300 ${currentQuestion.correct_option === 2 ? 'text-green-400 font-medium' : ''}`}
                          >
                            B. {currentQuestion.option_b}
                          </p>
                          {currentQuestion.option_c && (
                            <p
                              className={`text-gray-300 ${currentQuestion.correct_option === 3 ? 'text-green-400 font-medium' : ''}`}
                            >
                          ...
                          {currentQuestion.option_d && (
                            <p
                              className={`text-gray-300 ${currentQuestion.correct_option === 4 ? 'text-green-400 font-medium' : ''}`}
                            >
