...
const translations: Record<string, Record<string, string>> = { en: {
    ...
    'experience_tooltip': 'Gain experience by playing games and completing challenges',
    ...
    'profile_update_failed_desc': 'Your avatar was uploaded but we couldn\'t update your profile',
