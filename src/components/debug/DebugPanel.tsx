...
import { debugSystem  } from
  DebugLevel,
  DebugLogEntry,
  PerformanceMetrics,
  StateSnapshot,
  DebugConfig  } from '@/utils/debugSystem';
...
import { Bug, Download, Trash2, Play, Pause, RefreshCw  } from 'lucide-react';
 ...
 * 更新配置
 */
const updateConfig = (newConfig: Partial<DebugConfig>) => { const updatedConfig =  { ...config, ...newConfig  };
          ...
          <Tabs defaultValue={defaultTab} className='h-full flex flex-col'>
                  ...
                  {logs
                    .filter(log => {
                      if (
                        ...
                        !log.message
                          .toLowerCase()
                          .includes(logFilter.search.toLowerCase())
                      ) {
                        return false
}
                      return true
            ...
            <TabsContent value='config' className='flex-1 space-y-6'>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        updateConfig({ level: parseInt(value) 
})
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        updateConfig({ maxLogs: parseInt(e.target.value) 
})
                      }
                    />
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updateConfig({ showTimestamp: checked 
})
                      }
                    />
                  </div>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updateConfig({ showStack: checked 
})
                      }
                    />
                  </div>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updateConfig({ persistLogs: checked 
})
                      }
                    />
                  </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='disabled-modules'>
                    禁用的模块 (逗号分隔)
                  </Label>
                  <Input
                    id='disabled-modules'
                    ...
                    onChange={e =>
                      updateConfig({
                        disabledModules: e.target.value
                          .split(',')
                          .filter(m => m.trim()) })
                    }
                  />
