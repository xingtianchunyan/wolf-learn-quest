...
const removeMessage = (id: string) => { setMessages(prev => prev.filter(msg => msg.id !== id));,
};
...
// 技能相关的预设反馈
const showSkillSuccess = (skillName: string, targetName?: string) => { const actionText = targetName ? `对 ${targetName } 使用` : '使用';
  return showSuccess(;
    '技能使用成功',
