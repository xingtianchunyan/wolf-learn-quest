...
*
* @component
* @param { PlayerStatusManagerProps } props - 组件属性
* @returns { JSX.Element } 渲染的组件
* @hooks useEffect, useState, useAuth, useRoleStates, useRoleSelection, useMemo
*
* @example
* // 使用示例
...
const PlayerStatusManager: React.FC<PlayerStatusManagerProps> = ({ players,
  ...
  // 检查当前用户是否有权查看状态变更
  const canViewStatusChanges = React.useMemo(() => { if (!currentUserRole) return false;
  ...
  // 监听角色状态变更
  useEffect(() => { const newDyingPlayers: string[] = [];
