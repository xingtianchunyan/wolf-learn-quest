...
* @since 2024-12-19
* @category game
* @filepath game\panels\RoleStatusPanel.tsx
 */
...
*
* @component
* @param { RoleStatusPanelProps } props - 组件属性
* @returns { JSX.Element } 渲染的组件
* @hooks useState, useEffect, useRoleStates, usePlayersRealtime, useRoleDesigns
*
* @example
* // 使用示例
