...
* @since 2024-12-19
* @category game
* @filepath game\displays\GameStateDisplay.tsx
 */
...
*
* @component
* @param { GameStateDisplayProps } props - 组件属性
...
return (;
  ...
  { gameState.isPaused && (
    <Badge variant='outline' className='border-yellow-500 text-yellow-200'>;
    已暂停
    </Badge>
  ) }
  <Badge
