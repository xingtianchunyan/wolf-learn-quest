...
* @since 2024-12-19
* @category game
* @filepath game\interfaces\EnhancedSkillManager.tsx
 */
...
interface EnhancedSkillManagerProps { gameStateId: string;
  roomId: string;
  userId: string;
  currentRound: number;
  currentPhase: number;
...
/**
* EnhancedSkillManager 组件
*
* 处理游戏逻辑和状态管理
*
* @component
* @param { EnhancedSkillManagerProps } props - 组件属性
